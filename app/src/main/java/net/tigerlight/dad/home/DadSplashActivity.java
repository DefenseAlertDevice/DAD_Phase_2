...
import static net.tigerlight.dad.util.ServiceAlarmUtils.cancelPeriodicService;
...
public class DadSplashActivity extends AppCompatActivity {
...
//            startService(serviceIntent);
        ...
        final Intent loginIntent = new Intent(DadSplashActivity.this, DadMainActivity.class);
