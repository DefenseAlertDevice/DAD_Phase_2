...
public class DadReceiveElementAdapter extends BaseAdapter {
    ...
    public DadReceiveElementAdapter(Context context, OnDeleteItemClickListner contactFragment, JSONArray jsonArray, boolean isDataAvailable) {
