...
import net.tigerlight.dad.registration.fragment.DadAlertFragment;
...
public class DadAlertAdapter extends BaseAdapter {
    ...
    private DadAlertFragment alertFragment;
    private JSONObject jsonobject;
    private int i = 0;
    private String mCurrentEmail = "";
    private int mColor = -1;

    public DadAlertAdapter(Context context, DadAlertFragment alertFragment, JSONArray jsonArray) {
        this.context = context;
        this.alertFragment = alertFragment;

        mCurrentEmail = preference.mSharedPreferences.getString(DadConstant.KEY_EMAIL, "");
