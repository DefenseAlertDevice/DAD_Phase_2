...
public class DadUtils {
    ...
    private static final String TAG = DadUtils.class.getSimpleName();
    ...
    public static boolean isInternetConnected(final Context context) {
        ...
        final var networkCapabilities= connectivityManager.getNetworkCapabilities(connectivityManager.getActiveNetwork());

        var hasNetCapabilityInternet = false;
        var hasNetCapabilityValidated = false;

        if (networkCapabilities != null) {
            hasNetCapabilityInternet = networkCapabilities.hasCapability(NetworkCapabilities.NET_CAPABILITY_INTERNET);
            hasNetCapabilityValidated = networkCapabilities.hasCapability(NetworkCapabilities.NET_CAPABILITY_VALIDATED);

            return (hasNetCapabilityInternet && hasNetCapabilityValidated);
        }
