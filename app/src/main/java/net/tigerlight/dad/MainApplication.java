...
public class MainApplication extends Application  {
    ...
    public static MainApplication mAppInstance;
...
//        Log.d(TAG, "Creat");
        ...
        new GrizzlyMonitorBuilder(this).build().start();
...
//        configLanguage();
        ...
        {
            Preference.getInstance().savePreferenceData(DadConstant.IS_LANG_ID, "en");
            DadConstant.IS_LANGUAGE = false;
            ...
            Preference.getInstance().savePreferenceData(DadConstant.IS_ENG, true);
        }else if(lang.equalsIgnoreCase("da"))
        {
            Preference.getInstance().savePreferenceData(DadConstant.IS_LANG_ID, "da");
            DadConstant.IS_LANGUAGE = true;
            ...
            Preference.getInstance().savePreferenceData(DadConstant.IS_LANG_ID, "nb");
