...
public class CallDeleteAccount {
    private Context context;
    private String message;
    private boolean success;
    private String user_id;

    public CallDeleteAccount(final Context context) {
    ...
    private String generateLoginRequest() {
        ...
        builder.append("&userid" + "=").append(Preference.getInstance().mSharedPreferences.getString(DadConstant.USER_ID, ""));
