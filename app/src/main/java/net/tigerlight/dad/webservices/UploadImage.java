...
public class UploadImage {
    ...
    private RequestBody generateLoginRequest(final String profileImageId) {
        ...
        multipartBuilder.addFormDataPart(wsConstants.PARAMS_USER_ID, preference.mSharedPreferences.getString(DadConstant.USER_ID, ""));
...
//                multipartBuilder.addFormDataPart(wsConstants.PARAMS_FILE_NAME, "user_image_" + preference.mSharedPreferences.getString(C.USER_ID, "") + ".png", RequestBody.create(MediaType.parse("image/*"), fileAvatarImage));
                multipartBuilder.addFormDataPart(wsConstants.PARAMS_FILE_NAME, preference.mSharedPreferences.getString(DadConstant.USER_ID, "") + ".png", RequestBody.create(MediaType.parse("image/*"), fileAvatarImage));
            }
        }
