 ...
 */
public class WsUploadContactImage {
    private Context context;
    private String message;
    private boolean success;

    public WsUploadContactImage(final Context context) {
     ...
     * @return
     */
    public JSONObject executeService(final String profileImageId, final String contactId) {
        final String url;
        url = WsConstants.CONTACT_IMAGE_MAIN_URL;
        //url = WsConstants.IMAGE_TEST_URL;
        final String response = new WSUtil().callServiceHttpPost(context, url, generateLoginRequest(profileImageId, contactId));
     ...
     */
    private RequestBody generateLoginRequest(final String profileImageId, final String contactId) {
        final WsConstants wsConstants = new WsConstants();
        ...
        multipartBuilder.addFormDataPart(wsConstants.PARAMS_USER_ID, contactId);
...
//                multipartBuilder.addFormDataPart(wsConstants.PARAMS_FILE_NAME, "user_image_" + preference.mSharedPreferences.getString(C.USER_ID, "") + ".png", RequestBody.create(MediaType.parse("image/*"), fileAvatarImage));
                multipartBuilder.addFormDataPart(wsConstants.PARAMS_FILE_NAME, contactId + ".png", RequestBody.create(MediaType.parse("image/*"), fileAvatarImage));
            }
        }
