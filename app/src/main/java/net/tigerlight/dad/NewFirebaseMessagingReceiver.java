...
import static net.tigerlight.dad.registration.fragment.DadAlertFragment.jsonobjectToChange;
...
public class NewFirebaseMessagingReceiver extends BroadcastReceiver { // Changed from WakefulBroadcastReceiver
    ...
    private void updateInFront(Context context, Intent intent) {
        ...
        activityIntent.putExtra(DadConstant.JSON_OBJECT, jsonobjectToChange.toString());
    ...
    private void showNotification(Context context, Intent intentData) {
        ...
        final Intent intent = new Intent(context, DadMainActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        intent.putExtra(DadConstant.JSON_OBJECT, jsonObject);
