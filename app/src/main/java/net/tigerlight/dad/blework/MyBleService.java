...
public class MyBleService extends IntentService {
    private static final String CHANNEL_ID = "default";
    private String TAG = MyBleService.class.getName();
    ...
    private void serchiBeaconAvailability() {
        ...
        isBleSupported = true;
        dadBleHelper = new DadBLEHelper(this);
    ...
    private void callTestModeService() {
        if (DadUtils.isInternetConnected(getActivity())) {
    ...
    class AsyncTaskSendCrowdAlert extends AsyncTask<Void, Void, Void> {
        ...
        @Override
        protected Void doInBackground(Void... params) {
            callSendDanger = new CallSendDanger(MyBleService.this);
            callSendDanger.executeService(Double.parseDouble(latitude), Double.parseDouble(longitude), timezoneID, accuracy);
            return null;
        }
    ...
    class AsyncTestMode extends AsyncTask<Void, Void, Void> {
        ...
        @Override
        protected Void doInBackground(Void... params) {
            callDADTest = new CallDADTest(MyBleService.this);
            callDADTest.executeService();
            return null;
        }
